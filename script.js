            ...
            data.hits.hits.forEach(hit => {
                ...
                bookCard += `<div class="book-card">
                    ...
                    <div class="card-container">
                        <span>${hit._source["ISBN"]}</span>
                        <p class="title">${bookTitle}</p>
                        <p>${bookAuthor}</p>
                        <p><span>published by ${bookPublisher}</span></p>
                        <b>${hit._source["Year-Of-Publication"]}</b>
                    </div>
                </div>`;
            });
        }
